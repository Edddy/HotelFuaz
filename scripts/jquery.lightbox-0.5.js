...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'/content/images/loading.gif',		// (string) Path and the name of the loading icon
			...
			keyToPrev:				's',		// (string) (p = previous) Letter to show the previous image
			keyToNext:				'a',		// (string) (n = next) Letter to show the next image.
